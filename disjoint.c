...
void unionSets(int a, int b) {
    ...
    if (rep1==NULL || rep2==NULL) {
        printf("\nElement not present in the sets\n");
        return;
    }
    if (rep1!=rep2) {
...
void displayRepresentatives() {
    printf("\nRepresentatives of the Sets are: ");
...
int main() {
    ...
    printf("Enter the size of the set (choose between 1 to 25): ");
    scanf("%d", &setSize);

    while (setSize<=0 || setSize>25) {
        printf("Please enter a size between 1 and 25: ");
        scanf("%d", &setSize);
    }
